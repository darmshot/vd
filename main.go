...
func printInfo() {
	...
	println("rs --major - Release Start and upgrade to major version")
	println("rs --first - Release Start first")
	println("rf - Release Finish")
	println("rs --major - Release Finish and upgrade to major version")
	println("rs --first - Release Finish first")
	println("")
